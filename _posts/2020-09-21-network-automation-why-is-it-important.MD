...
![Maintenance's Logical Diagram](/assets/img/posts/2020-09-21/fig1-maintenance-logical-diagram.webp){: w="900" h="600" }
...
[![AWS Infrastructure Map](/assets/img/posts/2020-09-21/fig3-aws-infrastrusture-map.webp){: w="900" h="600" }](https://aws.amazon.com/about-aws/global-infrastructure/regions_az/){:target="_blank"}
